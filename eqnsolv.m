function [tf, G, decoded, parity, count, numDecoded] = eqnsolv(G, message, method, row, decoded, parity, count)
...
elseif method == 2
    ...
    [ G, parity, decoded, tf, count, numDecoded ] = substitutionSolver( G, parity, decoded, row, count );
end
end
